  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        >
          Déménageur professionnel certifié NF — Paris & International
        </motion.p>

        {/* H1 animated */}
        <SplitText
          text="Votre Déménagement, Notre Expertise."
        ...
        >
          TransLog Pro accompagne particuliers et entreprises dans leurs déménagements
          en Île-de-France et à l&apos;international depuis 2007. Assurance tous risques
          incluse, devis gratuit sous 24h.
        </motion.p>
        ...
        >
          {["Assurance tous risques", "Devis sous 24h", "Équipes certifiées", "+4 800 déménagements"].map((badge) => (
