            ...
            <FadeUp key={t.id} delay={i * 0.1}>
              <div className="h-full flex flex-col p-6 md:p-8 rounded-2xl bg-neutral-50 border border-neutral-200">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-primary-200 flex items-center justify-center text-primary-800 font-semibold text-sm shrink-0">
                    {t.clientName.charAt(0)}
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-neutral-900">{t.clientName}</p>
                    <p className="text-xs text-neutral-500">{t.location} · {t.projectType}</p>
                  </div>
                </div>
              </div>
            </FadeUp>
