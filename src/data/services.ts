...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Plateforme logistique au Havre : stockage sécurisé, gestion des flux entrants et sortants, préparation de commandes.",
    fullDescription:
      "Notre entrepôt de la Chaussée de la Moselle, idéalement situé à proximité du port du Havre, offre une solution logistique complète pour les entreprises. Réception, stockage, préparation de commandes et expédition : nous gérons l'intégralité de vos flux logistiques avec rigueur et traçabilité. Adapté aux entreprises de toute taille.",
    icon: "Warehouse",
    image: "/images/services/demenagement-entreprise.png",
    features: [
      "Entrepôt sécurisé au Havre",
      "Gestion des entrées et sorties de stock",
      "Préparation de commandes",
      "Étiquetage et conditionnement",
      "Reporting et traçabilité en temps réel",
      "Accès direct port du Havre",
    ],
    price: "Devis sur mesure",
  ...
  },
  {
    ...
    features: [
      ...
      "Départ depuis le port du Havre",
  ...
  },
  {
    ...
    title: "Manutention",
    shortDescription:
      "Chargement, déchargement, gerbage et mise en place de marchandises — nos équipes interviennent sur site à Le Havre et en Normandie.",
    fullDescription:
      "Nos équipes de manutentionnaires qualifiés interviennent pour le chargement et déchargement de vos véhicules, la mise en palette, le gerbage et la mise en place de marchandises lourdes ou volumineuses. Disponibles à Le Havre et dans toute la Normandie, ils s'adaptent à vos contraintes horaires et à vos exigences de sécurité.",
    icon: "PackageCheck",
    ...
    features: [
      ...
      "Équipes disponibles en Normandie",
    ],
